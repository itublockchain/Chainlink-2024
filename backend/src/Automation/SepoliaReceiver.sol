...
contract SepoliaReceiver is CCIPReceiver, OwnerIsCreator {
    ...
    address public  immutable i_staker;
    ...
    function setSenderForSourceChain(
        ...
        address _sender
    ) public validateSourceChain(_sourceChainSelector) {
    ...
    function retryFailedMessage(bytes32 messageId, address beneficiary)
        external
    ...
    function getFailedMessages(uint256 offset, uint256 limit)
        external
        view
